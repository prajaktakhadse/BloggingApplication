...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application ",
				"This project is is an individual project", "1.0", "Terms of Service",
				new Contact("Prajakta", "https://github.com/prajaktakhadse/BloggingApplication", "prajaktakhadse00@gmail.com"),
